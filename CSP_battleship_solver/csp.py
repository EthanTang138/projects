...
class Variable:
    ...
    def dumpVar(self):
        print("Variable\"{}={}\": Dom = {}, CurDom = {}".format(self._name, self._value, self._dom,
                                                                self._curdom))
...
class CSP:
    ...
    def __init__(self, name, variables, constraints):
        ...
        for v in variables:
            if v not in varsInCnst:
                print("Warning: variable {} is not in any constraint of the CSP {}".format(v.name(),
                                                                                           self.name()))
        for v in varsInCnst:
    ...
    def constraintsOf(self, var):
        ...
        try:
            ...
            print("Error: tried to find constraint of variable {} that isn't in this CSP {}".format(
                var, self.name()))
